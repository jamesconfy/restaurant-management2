migrate_up:
	migrate -path db/migration -database "postgres://mac:password@localhost:5432/restaurant_management?sslmode=disable" -verbose up

migrate_down:
	migrate -path db/migration -database "postgres://mac:password@localhost:5432/restaurant_management?sslmode=disable" -verbose down

migrate_force:
	migrate -path db/migration -database "postgres://mac:password@localhost:5432/restaurant_management?sslmode=disable" force $(version)
